import { SERVICE_CARDS, type ServiceCard } from "@/data/home-content";
import ServiceFlipCard from "./ServiceFlipCard";

function isServiceFlipCard(card: ServiceCard): card is ServiceCard & { flipBackImage: string } {
  return Boolean(card.flipBackImage);
}
  ...
  return (
    <section id="services">
      <div className="container">
        <div style={{ textAlign: "center", maxWidth: 600, margin: "0 auto 0.4rem" }} className="reveal">
        ...
        <div className="services-grid">
          {SERVICE_CARDS.map((card) =>
            isServiceFlipCard(card) ? (
              <ServiceFlipCard key={card.num} card={card} />
            ) : (
